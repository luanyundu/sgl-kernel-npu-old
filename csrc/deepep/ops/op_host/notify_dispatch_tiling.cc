                                               ...
                                               NotifyDispatchTilingData &tilingData, std::string &commGroup)
{
    ...
    OP_TILING_CHECK(
        perRoundTokensPtr == nullptr, OP_LOGE(nodeName, "perRoundTokensPtr is null."), return ge::GRAPH_FAILED);
...
static bool CheckTensorDataType(gert::TilingContext *context, const char *nodeName)
{
    ...
    OP_TILING_CHECK((recvCount->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "recvCount datatype is invalid, datatype should be int, but is %d.",
    ...
    OP_TILING_CHECK((recvOffset->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "recvOffset datatype is invalid, datatype should be int, but is %d.",
    ...
    OP_TILING_CHECK((expertGlobalOffset->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "expertGlobalOffset datatype is invalid, datatype should be int, but is %d.",
    ...
    OP_TILING_CHECK(srcrankInExpertOffset == nullptr, OP_LOGE(nodeName, "srcrankInExpertOffset is null."), return false);
    OP_TILING_CHECK((srcrankInExpertOffset->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "srcrankInExpertOffset datatype is invalid, datatype should be int, but is %d.",
    ...
    OP_TILING_CHECK((rInSrcrankOffset->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "rInSrcrankOffset datatype is invalid, datatype should be int, but is %d.",
    ...
    OP_TILING_CHECK((totalRecvTokens->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "totalRecvTokens datatype is invalid, datatype should be int, but is %d.",
    ...
    OP_TILING_CHECK((maxBs->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "maxBs datatype is invalid, datatype should be int, but is %d.",
    ...
    OP_TILING_CHECK((recvTokensPerExpert->GetDataType() != ge::DT_INT32),
        OP_LOGE(
            nodeName,
            "recvTokensPerExpert datatype is invalid, datatype should be int, but is %d.",
