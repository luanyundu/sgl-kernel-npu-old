...
std::tuple<
    ...
    at::Tensor,
    at::Tensor>
Buffer::notify_ver(const at::Tensor &x, const std::optional<at::Tensor> &x_scales,
                           ...
                           bool async, bool allocate_on_comm_stream, bool use_quant)
{
    ...
    int64_t real_max_bs = static_cast<int64_t>(
    ...
    auto recv_count_one_dim = recv_count.sum(0, true).to(at::kInt);
	// Return values
    return {expandx_out,
            dynamic_scales_out,
            recv_topk_idx,
                          ...
                          const torch::Tensor &send_head, const std::optional<at::Tensor> &combine_send_cost_stats)
{
    ...
    int64_t tp_rankId = 0;
    int64_t moe_expert_number = send_head.size(1);
